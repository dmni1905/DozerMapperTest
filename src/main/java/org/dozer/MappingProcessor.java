...
public class MappingProcessor implements Mapper {
    ...
    private final Logger log = LoggerFactory.getLogger(org.dozer.MappingProcessor.class);
  ...
  /* End of Mapper Interface Implementation */
     ...
     * {@link org.dozer.MappingProcessor#mapToDestObject(ClassMap, Object, Object, boolean, String)} function with
